                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr id="product1">
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('assets/img/mariamatress-product1.png') }}" alt="mariamatress-product" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;">
                                    </div>
                                </th>
                                <td>
                                ...
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" id="hide" onclick="confirmRemoveRow(this)">
                                                                                <i class="fa fa-times text-danger" id="hide"></i>
                                    </button>
                            ...
                            <tr id="product2">
                                ...
                                <td>
                                    <div class="input-group quantity2 mt-4" style="width: 100px;">
                                        ...
                                        <input type="text" class="form-control form-control-sm text-center border-0 quantity-input2" value="1">
                                        <div class="input-group-btn">
                                            <button class="btn btn-sm btn-plus rounded-circle bg-light border">
                                                <i class="fa fa-plus"></i>
                                            </button>
                                ...
                                <p class="mb-0 mt-4">£ <span id="totalprice2">54.99</span></p>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" id="hide2" onclick="confirmRemoveRow(this)">
                                      <i class="fa fa-times text-danger" id="hide2"></i>
                                    </button>
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="{{ asset('assets/img/mariamatress-product1.png') }}" alt="mariamatress-product" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="" alt="">
                                    </div>
                                </th>
                                <td>
