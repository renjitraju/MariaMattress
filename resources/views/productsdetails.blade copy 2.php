                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr id="product1">
                                ...
                                <td>
                                    <p class="mb-0 mt-4">£ <span id="price">3</span></p>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">£ <span id="totalprice">3</span></p>
                                </td>
                                <td>
                            ...
                            <tr id="product2">
                                ...
                                <td>
                                    <p class="mb-0 mt-4">£ <span id="price2">5</span></p>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">£ <span id="totalprice2">5</span></p>
                                </td>
                                <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" id="hide" onclick="confirmRemoveRow(this)">
                                                                                <i class="fa fa-times text-danger" id="hide"></i>
