 ...
 <div class="container border-bottom border-1">
     <nav class="navbar navbar-expand-lg navbar-light p-0">
         ...
         <div class="collapse navbar-collapse" id="navbarCollapse">
             ...
             <a href="{{route('home.cart', ['type' => Crypt::encrypt('xvcv')])}}" class="btn btn-outline-light py-2 px-4 d-none d-lg-inline-block position-relative">Cart<span class="position-absolute top-0 start-100 translate-middle badge border border-light rounded-circle bg-danger p-2"><span class="visually-hidden">unread messages</span></span></a>
         </div>
     </nav>
 </div>
</div>
