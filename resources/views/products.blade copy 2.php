                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        {{-- <a href="{{ route('home.cart', Crypt::encrypt('single','56.99')) }}" class="btn btn-product px-3 mt-3">Add To Cart</a> --}}
                            <a href="{{ route('home.cart', ['type' => Crypt::encrypt('SINGLE : 90 x 190+25 cm'), 'price' => Crypt::encrypt('54.99')]) }}" class="btn btn-product px-3 mt-3">Add To Cart</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                        <div class="product-item text-center border h-100 p-4">
                            ...
                            <cite title="Source Title">*Quantity can be change in the cart</cite>
                            <a href="{{ route('home.cart', Crypt::encrypt('double')) }}" class="btn btn-product px-3 mt-3">Add To Cart</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                        <div class="product-item text-center border h-100 p-4">
                            ...
                            <cite title="Source Title">*Quantity can be change in the cart</cite>
                            <a href="{{ route('home.cart', Crypt::encrypt('king')) }}" class="btn btn-product px-3 mt-3">Add To Cart</a>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    var singlePrice = parseFloat($('#singleprice').text().replace('£', ''));
