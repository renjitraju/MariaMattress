                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr id="product1">
                                ...
                                <td>
                                    <p class="mb-0 mt-4">£ <span id="price">3.00</span></p>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">£ <span id="totalprice">3.00</span></p>
                                </td>
                                {{-- <td>
                            ...
                            <tr id="product2">
                                ...
                                <td>
                                    <p class="mb-0 mt-4">£ <span id="price2">5.00</span></p>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">£ <span id="totalprice2">5.00</span></p>
                                </td>
                                {{-- <td>
                                    <button class="btn btn-md rounded-circle bg-light border mt-4" id="hide" onclick="confirmRemoveRow(this)">
                                                                                <i class="fa fa-times text-danger" id="hide"></i>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
        ...
        $(document).ready(function() {
            function calculateTotal() {
                var total1 = parseFloat($('#totalprice').text());
                var total2 = parseFloat($('#totalprice2').text());
            ...
            $(document).ready(function() {
                ...
                $('.btn-plus, .btn-minus,.btn-plus2, .btn-minus2').click(function() {
                    calculateTotal();
                });
            });
