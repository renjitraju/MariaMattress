                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user-menu">
                      <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <img src="{{asset('mariaadmin/assets/images/user/user-xs-01.jpg')}}" class="user-image rounded-circle" alt="User Image" />
                       {{-- {{ dd(Auth::guard('admin')->username);}}
                        @if(isset(auth()->guard('admin')->username))
                        <span class="d-none d-lg-inline-block"> {{auth()->guard('admin')->username}} ss </span>
                         @endif --}}
